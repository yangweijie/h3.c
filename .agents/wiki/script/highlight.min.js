...
return Ke}()
;"object"==typeof exports&&"undefined"!=typeof module&&(module.exports=hljs);/*! `dockerfile` grammar compiled for Highlight.js 11.10.0 */
...
;hljs.registerLanguage("dockerfile",e)})();/*! `dart` grammar compiled for Highlight.js 11.10.0 */
...
;hljs.registerLanguage("dart",e)})();/*! `scala` grammar compiled for Highlight.js 11.10.0 */
...
begin:"@[A-Za-z]+"}]}}})();hljs.registerLanguage("scala",e)})();/*! `nginx` grammar compiled for Highlight.js 11.10.0 */
